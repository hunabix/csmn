...
<div id="<?= $notificacion['ID']; ?>" class="Notificaciones-notificacion form">
	<!-- Titulo -->
	<a class="Notificaciones-notificacionTitulo notice" data-toggle="modal" data-target="#modal-notificacion" titulo="<?= $notificacion['titulo']; ?>" desc="<?= $notificacion['descripcion']; ?>" fecha="<?= $notificacion['fecha_notificacion']; ?>" tipo="<?= $notificacion['tipo']; ?>">
	    <?= $notificacion['titulo']; ?>  
	</a>
