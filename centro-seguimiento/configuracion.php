...
// -------------------------------------------------------------------------//
if (isset($_POST['configuracion-btn'])) { // el formulario ha sido enviado
	if(isset($_POST['inicio-ins'])){ $inicio_ins = $_POST['inicio-ins']; }
	if(isset($_POST['inicio-cur'])){ $inicio_cur = $_POST['inicio-cur']; }
	if(isset($_POST['ciclo-esc'])){ $ciclo_esc = $_POST['ciclo-esc']; }
	if(isset($_POST['temporada'])){ $temporada = $_POST['temporada']; }	
